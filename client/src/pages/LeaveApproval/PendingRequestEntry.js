...
function PendingRequestEntry(props) {
  ...
  return (
    <tr>
      ...
      <td><button type="button" onClick={()=>props.onStatusChange(props.entry._id,"approved")}>Accept</button> <button type="button" onClick={()=>props.onStatusChange(props.entry._id,"rejected")}>Reject</button></td>
    </tr>
  );
}
